    ...
    <div class="flex md:flex-row-reverse flex-wrap">
        ...
        <div class="md:relative mx-auto lg:float-right lg:px-6">
            <ul class="list-reset flex flex-row md:flex-col text-center md:text-left">
                ...
                @else
                    <li class="mr-3 flex-1">
                        <a href="{{route('user.profile')}}" class="block py-1 md:py-3 pl-1 align-middle text-gray-800 no-underline hover:text-pink-500 border-b-2 border-gray-800 md:border-gray-900 hover:border-pink-500">
                ...
                @else
                    <li class="mr-3 flex-1">
                        ...
                        <i class="fas fa-link pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Archive</span>
                        </a>
                    </li>
                @endif
